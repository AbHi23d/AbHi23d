...
- **Data Analysis & Analytics Engineering**
  ...
  - Designing analysis-ready datasets
  - Data validation & exploratory analysis (EDA)

- **Operational & Applied Analytics**
  - KPI tracking and performance analysis
  - Risk-based and trade-off driven decision support
  - Translating analytical findings for non-technical stakeholders

- **Predictive & Statistical Analytics**
  - Classification and regression models
  - Feature engineering and evaluation
  - Interpretable, practical modeling over black-box hype
